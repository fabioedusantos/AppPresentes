...
class PresentesModel extends CI_Model {
    public function get($id = null) {
        $query = "SELECT * FROM presentes "; if (!empty($id)) $query .= "WHERE id = $id "; $query .= "ORDER BY dataCadastro DESC";
        $query = $this->db->query($query); if (empty($query->result_array())) return null;
